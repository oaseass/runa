...
// Global country dialing options used by the onboarding phone step.
...
export const DEFAULT_COUNTRY_ISO2 = "KR";

export const DEFAULT_COUNTRY =
  COUNTRY_DIAL_OPTIONS.find((country) => country.iso2 === DEFAULT_COUNTRY_ISO2) ??
