...
const KICKER_POOL: Record<string, Record<string, string[]>> = {
  love: {
    ...
    challenge: [
      "끌림은 분명하지만, 속도 조절이 더 중요합니다",
      "감정보다 경계선이 먼저 필요한 순간",
      "이 에너지를 천천히 다루는 것이 유리합니다",
    ],
    neutral: [
      "연결의 방향을 느끼기 좋은 날",
      "관계에서 무엇을 원하는지 살피기 좋은 날",
      "조용하게 관계의 온도를 확인하세요",
    ],
  },
  friends: {
...
const SECONDARY_POOL: Record<string, Record<string, string[]>> = {
  love: {
    strength: [
      "지금 흐르는 에너지는 연결을 향해 열려 있습니다. 상대의 신호를 받아들이되, 나의 속도를 놓치지 않는 것이 중요합니다.",
      "감정이 선명한 만큼 표현이 쉬워지는 날입니다. 끌림의 강도가 높을수록 천천히 움직이는 편이 깊은 연결로 이어집니다.",
      "오늘 관계에서 느끼는 끌림은 진짜입니다. 그 에너지를 충동으로 쓰기보다 방향으로 삼아보세요.",
    ],
    challenge: [
      "감정이 먼저 움직이는 날입니다. 연인이나 관심 있는 사람과의 대화에서 반응보다 잠시 멈추는 것이 더 나은 결과를 만듭니다.",
      "매력적인 상황이 만들어질 수 있지만, 그 흐름을 어떻게 다루느냐가 오늘의 진짜 과제입니다. 경계선을 의식적으로 유지하세요.",
      "관계에서 긴장이 생긴다면, 상대에 대한 반응인지 내 안의 무언가에 대한 반응인지 구분해보는 것이 도움이 됩니다.",
    ],
    neutral: [
      "연애나 관계 쪽에서 눈에 띄는 변화는 없지만, 조용히 감정을 정렬하기 좋은 날입니다.",
      "지금은 크게 움직이기보다 내가 이 관계에서 무엇을 원하는지 느끼기 좋은 시간입니다.",
      "관계가 잠시 숨을 고르는 순간입니다. 강제로 무언가를 만들려 하기보다 자연스러운 흐름을 따르세요.",
    ],
  },
  friends: {
    strength: [
